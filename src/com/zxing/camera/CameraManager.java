...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			// int width = Utils.dip2px(context, context.getResources()
			// .getDimension(R.dimen.px_590));
			// int height = Utils.dip2px(context, context.getResources()
			// .getDimension(R.dimen.px_274));
			//
			// int leftOffset = Utils.dip2px(context, context.getResources()
			// .getDimension(R.dimen.px_22));
