package com.pregnancy.app.authentication;
...
import com.pregnancy.app.activity.MainActivityGroup;
...
public class ActionTask extends BaseActionTask<ActionResult> {
	...
	private void doNotVerify(final Activity activity, final ActionResult result) {
		...
		new ActionProcessor().jumpToLoginActivity(activity, intent, LOGIN_TYPE.Exit_To_Cancel_Apk);
	}
